...
public class FinalClassAndMethods {
    ...
    private static final InherentMath math = new Top();
    private static final InherentMath finalMath = new FinalTop();
    ...
    public int inherentTop() {
        return math.finalTopAdd(left, right);
    }

    @Benchmark
    public int inherentBottom() {
        return math.finalBottomAdd(left, right);
    }

    @Benchmark
    public int finalInherent() {
        return finalMath.add(left, right);
    }

    @Benchmark
    public int finalInherentTop() {
        return finalMath.finalTopAdd(left, right);
    }

    @Benchmark
    public int finalInherentBottom() {
        return finalMath.finalBottomAdd(left, right);
    }
    ...
    public int klassFinalMethod() {
        return Math.finalAdd(left, right);
    }
    ...
    public int finalClassFinalMethod() {
        return FinalMath.finalAdd(left, right);
    }
    ...
    public interface InherentMath {
        int add(int i, int j);
        int finalTopAdd(int i, int j);
        int finalBottomAdd(int i, int j);
    }

    public static abstract class Bottom implements InherentMath {
        @Override
    ...
    public static class Top extends Bottom {
        @Override
        public int add(int i, int j) {
            return i + j;
        }
    ...
    public final static class FinalTop extends Bottom {
        @Override
        public int add(int i, int j) {
            return i + j;
        }
